...
window.NNV_DATA = {
  ...
  items: [
    ...
    { id: "towel-rider", title: "Rider Towel", category: "objects",
      ...
      desc: "Jacquard terry towel, 50 × 70 cm. The archive horseman is woven into the pile, not printed, so the colour edges stay slightly ragged and the loops catch the light. Woven NW label at the bottom centre. 100% cotton, hanging loop. Two colourways: yellow rider with a blue standard on pink, and a dark green rider with ochre hooves and a white standard on sea teal.",
      ...
      colors: [{ id: "pink", label: "Pink", swatch: "#CEA5B3", image: "img/p12.webp", images: ["img/towel-rider/m1.webp", "img/towel-rider/f2.webp", "img/towel-rider/f3.webp", "img/towel-rider/f4.webp", "img/towel-rider/f5.webp", "img/towel-rider/f6.webp"] }, { id: "teal", label: "Sea teal", swatch: "#377D81", image: "img/towel-rider/teal-main.webp", images: ["img/towel-rider/teal-f2.webp", "img/towel-rider/teal-f3.webp", "img/towel-rider/teal-f4.webp"] }],
      process: [{ src: "img/process/board-towel-knight.webp", cap: "Rider silhouette on the towel, the ink-drawn knight on a tee and the pink cardholder" }] },
    ...
    { id: "earrings-cameo", title: "Bone Cameo Drop Earrings", category: "accessories",
      ...
      process: [{ src: "img/process/lineup-01.webp", cap: "Season line-up FW 26/27 — the looks this piece was drawn into" }] },
    { id: "belt-graffiti", title: "Graffiti Patch Leather Belt", category: "accessories",
      price: 170, colorGroup: "black", sku: "NNV0316A",
      lead: "Someone's wall, buckled on.",
      desc: "Wide belt in black leather, its outer face rebuilt from painted panels: hand-drawn graffiti in white, black and orange, a black-and-white checkerboard tail, ruffled leather frills running along one edge. Antique brass roller buckle, a second D-ring lower down, engraved silver tip at the end. Plain black leather on the inside.",
      image: "img/belt-graffiti/main.webp", images: ["img/belt-graffiti/f2.webp", "img/belt-graffiti/f3.webp", "img/belt-graffiti/f4.webp"],
      process: [{ src: "img/process/lineup-01.webp", cap: "Season line-up FW 26/27 — the looks this piece was drawn into" }] },
    ...
    { id: "sweater-shadow", title: "Shadow Turtleneck Grey", category: "clothes",
      ...
      process: [{ src: "img/process/board-knight-black.webp", cap: "Black three-thread cotton with knight graphic: ribbed collar and cuffs, embroidery vs print; the lace-hem skirt and the faces tote" }] },
    { id: "fan-rider", title: "Rider Hand Fan", category: "accessories",
      price: 110, colorGroup: "black", sku: "NNV0319A",
      lead: "The rider, folded into twenty-two pleats.",
      desc: "Folding hand fan: twenty-two flat lacquered sticks carrying one continuous silk leaf, the top edge scalloped between the sticks, the stick tips showing as a fine line along it. The archive knight on a galloping horse is printed large across the leaf and breaks along the folds. Thicker lacquered guard sticks, brass rivet with an oval plate stamped NNV in gold. Three colourways: black silk with the rider in cornflower blue and pink, creamy lemon with the rider in black and smoky green, wine red with the rider in cobalt and white.",
      image: "img/fan-rider/main.webp", images: ["img/fan-rider/f2.webp", "img/fan-rider/f3.webp", "img/fan-rider/f4.webp"],
      colors: [{ id: "black", label: "Black", swatch: "#141416", image: "img/fan-rider/main.webp", images: ["img/fan-rider/f2.webp", "img/fan-rider/f3.webp", "img/fan-rider/f4.webp"] }, { id: "lemon", label: "Lemon", swatch: "#E7DDA6", image: "img/fan-rider/yellow-main.webp", images: ["img/fan-rider/yellow-f2.webp"] }, { id: "wine", label: "Wine red", swatch: "#7C1D22", image: "img/fan-rider/red-main.webp", images: ["img/fan-rider/red-f2.webp"] }],
      process: [{ src: "img/process/board-towel-knight.webp", cap: "Rider silhouette on the towel, the ink-drawn knight on a tee and the pink cardholder" }] },
    ...
    { id: "case-heart", title: "Nesting Heart Keyring", category: "accessories",
      ...
      desc: "Heart-shaped case in emerald-green metal, carried on a key ring. The lift-off lid is engraved with N N V in a wobbly hand-drawn line, and the side wall is scratched all over with childish drawings \u2014 a sun, a house, little figures and a winged NANAVA heart. The case unstacks: two smaller heart cases nest one inside the other, and the smallest opens onto bare polished steel. A short chain runs from the case to the split ring, which carries a daisy with cut petals and a spiral centre, a small key, a long tag engraved with the same drawings, and two little hearts marked N and V. Every mark is pressed into the metal itself, nothing printed.",
      image: "img/case-heart/main.webp", images: ["img/case-heart/f2.webp", "img/case-heart/f3.webp", "img/case-heart/f4.webp", "img/case-heart/f5.webp", "img/case-heart/f6.webp"],
      process: [{ src: "img/process/board-nnv-tight.webp", cap: "Very tight, translucent silhouette with the NNV mark; scarf variants of the rider print" }] },
    { id: "sweater-harbour", title: "Harbour Line Sweater", category: "clothes",
      ...
      colors: [{ id: "violet", label: "Violet", swatch: "#4A3E7A", image: "img/sweater-harbour/main.webp", images: ["img/sweater-harbour/f2.webp", "img/sweater-harbour/f3.webp", "img/sweater-harbour/f4.webp", "img/sweater-harbour/f5.webp", "img/sweater-harbour/f6.webp"] }, { id: "burgundy", label: "Burgundy", swatch: "#7B2230", image: "img/sweater-harbour/burgundy-main.webp", images: ["img/sweater-harbour/burgundy-f2.webp", "img/sweater-harbour/burgundy-f3.webp", "img/sweater-harbour/burgundy-f4.webp"] }],
      process: [{ src: "img/process/lineup-01.webp", cap: "Season line-up FW 26/27 — the looks this piece was drawn into" }] },
    { id: "shirt-rider-stripe", title: "Rider Striped Shirt", category: "clothes",
      ...
      process: [{ src: "img/process/board-knight-black.webp", cap: "Black three-thread cotton with knight graphic: ribbed collar and cuffs, embroidery vs print; the lace-hem skirt and the faces tote" }] },
    { id: "scarf-knight-olive", title: "Knight Silk Scarf Olive", category: "accessories",
      price: 150, colorGroup: "green", sku: "NNV0323A",
      lead: "The rider in lilac and lemon, on olive.",
      desc: "Square 90 × 90 cm scarf in silk twill with a hand-rolled hem. The archive knight rides across a deep olive field in lilac, lemon and ink black, framed by a narrow lavender border. Worn at the neck, tied to a bag or spread out like a small tapestry.",
      image: "img/scarf-knight-olive/main.webp", images: [] },
    { id: "bag-hobo-portrait", title: "Portrait Hobo Bag Lilac", category: "bags",
      price: 290, colorGroup: "lilac", sku: "NNV0209A",
      lead: "A painted face you carry on the shoulder.",
      desc: "Soft hobo bag in pale lilac coated canvas with a single long strap cut in one piece with the body. On the front — a painted portrait in green, violet and rust, printed edge to edge so it wraps around the side seams. Unlined interior with one flat pocket.",
      image: "img/bag-hobo-portrait/main.webp", images: [] },
    { id: "cap-flower", title: "Black Flower Hood Cap", category: "accessories",
      price: 180, colorGroup: "black", sku: "NNV0324A",
      lead: "A cap that blooms around the face.",
      desc: "Baseball cap in black cotton twill with padded petals that fold down around the face like a flower hood. The petals are joined by domed snaps, so the cap can be worn open, half-closed or fully framing the head. Adjustable strap at the back.",
      image: "img/cap-flower/main.webp", images: [] },
    { id: "collar-fur", title: "Two-Tone Fur Collar", category: "accessories",
      price: 320, colorGroup: "brown", sku: "NNV0325A",
      lead: "Smoke on top, dusty pink underneath.",
      desc: "Oversized detachable collar in long-pile faux fur: smoky brown and grey on the shoulders, shading into dusty pink at the long front tails. Hook fastening at the neck, so it sits over a coat, a denim jacket or bare skin.",
      image: "img/collar-fur/main.webp", images: [] },
    { id: "beanie-topknot", title: "Yellow Topknot Beanie", category: "accessories",
      price: 95, colorGroup: "yellow", sku: "NNV0326A",
      lead: "A knot of lemon yarn on the crown.",
      desc: "Close-fitting beanie in brushed lemon-yellow wool, knitted to hug the head like hair. The crown gathers into a tall loose topknot finished with a pompom; long strands fall down one side like a side ponytail.",
      image: "img/beanie-topknot/main.webp", images: [] },
    { id: "skirt-lace-taupe", title: "Crown Lace Satin Skirt Taupe", category: "clothes",
      price: 220, colorGroup: "brown", sku: "NNV0131A",
      lead: "A jagged crown in white lace on warm satin.",
      desc: "Midi slip skirt in fluid taupe satin. A large jagged crown in ivory floral lace is appliquéd down the front, outlined with a fine navy cord. A deep band of scalloped white lace runs along the hem. Elastic waist, bias cut that moves with every step.",
      image: "img/skirt-lace-taupe/main.webp", images: [] },
    { id: "legwarmers-lace", title: "Lace-Up Cable Leg Warmers", category: "clothes",
      price: 140, colorGroup: "pink", sku: "NNV0132A",
      lead: "Boots knitted from a sweater.",
      desc: "Knee-high leg warmers in dusty rose cable knit, laced up the front through metal eyelets like riding boots. A stirrup band runs under the foot and leaves the toes and heel bare. Wool blend with a soft brushed inside.",
      image: "img/legwarmers-lace/main.webp", images: [] },
    { id: "dress-ruched", title: "Ruched Handkerchief Dress Grey", category: "clothes",
      price: 380, colorGroup: "grey", sku: "NNV0133A",
      lead: "Gathered close, falling in points.",
      desc: "Long-sleeve dress in heathered grey wool jersey. The bodice and sleeves are ruched along vertical channels, the puffed shoulders stand up high, and the skirt falls into a deep handkerchief hem with long pointed ends. Also worn in slate blue.",
      image: "img/dress-ruched/main.webp", images: [] },
    { id: "coat-garland", title: "Flower Garland Wool Coat", category: "clothes",
      price: 690, colorGroup: "grey", sku: "NNV0134A",
      lead: "A garland of metal flowers across the chest.",
      desc: "Double-breasted overcoat in grey melange wool with a belted waist and wide lapels. A garland of cast flowers in antique gold and silver crosses the body from shoulder to hip and continues along the collar. The flowers are stitched on by hand and can be removed for cleaning.",
      image: "img/coat-garland/main.webp", images: [] },
    { id: "charm-horns", title: "Horned Shell Bag Charm", category: "accessories",
      price: 85, colorGroup: "pink", sku: "NNV0327A",
      lead: "A little pink relic for the bag.",
      desc: "Bag charm in rose-gold plated brass: a long loop, a fan shell with curled horns and a small round locket that opens. Two flat ribbon ends hang from the bottom. Clips onto a handle, a belt loop or keys.",
      image: "img/charm-horns/main.webp", images: [] },
    { id: "tee-sketch", title: "Sketch Oversized T-Shirt White", category: "clothes",
      price: 120, colorGroup: "cream", sku: "NNV0135A",
      lead: "The whole drawing, not a crop.",
      desc: "Oversized t-shirt in heavyweight white cotton with dropped shoulders and elbow-length sleeves. On the front — a full-height grey pencil drawing from the archive: tangled figures, antlers and leaves, printed at original scale so every line stays visible.",
      image: "img/tee-sketch/main.webp", images: [] },
    { id: "hood-pleat", title: "Pleated Hood Cape", category: "clothes",
      price: 260, colorGroup: "black", sku: "NNV0136A",
      lead: "A hood that opens like a fan.",
      desc: "Short hooded cape in black technical fabric, permanently sun-ray pleated from the neck down to a sharp point at the chest and back. The hood closes high over the chin with a hidden zip. Worn over a coat or on its own. Also in dark olive.",
      image: "img/hood-pleat/main.webp", images: [] },
    { id: "towel-rider-teal", title: "Rider Towel Teal", category: "objects",
      price: 65, colorGroup: "teal", sku: "NNV0402A",
      lead: "The black horseman on deep teal.",
      desc: "Jacquard terry towel, 50 × 70 cm. The archive horseman is woven in black on a deep teal ground, with ochre hooves and a pale flag; the colours sit in the pile, not on top of it. Woven NNV label at the bottom edge.",
      image: "img/towel-rider-teal/main.webp", images: [] },
    { id: "dog-collar", title: "Dog Collar & Bandana", category: "accessories",
      price: 70, colorGroup: "pink", sku: "NNV0328A",
      lead: "Made for Bulochka first.",
      desc: "Dog collar in dusty pink leather with a sculpted wing and hanging charms, plus a teal version with tassels and a matching knotted bandana. Brass buckle, D-ring for the lead, embossed NNV plate. Sizes S–L.",
      image: "img/dog-collar/main.webp", images: [] },
    { id: "dress-cutout", title: "Cutout Tulle Dress Black", category: "clothes",
      price: 420, colorGroup: "black", sku: "NNV0137A",
      lead: "Round windows in a black silhouette.",
      desc: "Sleeveless midi dress with a fitted jersey bodice and a full skirt in layered black tulle. Round cutouts are placed at the collarbones and under the bust, edged in a thin bound trim. Worn alone or under a sweater.",
      image: "img/dress-cutout/main.webp", images: [] },
    { id: "belt-wave", title: "Wave Buckle Leather Belt", category: "accessories",
      price: 180, colorGroup: "silver", sku: "NNV0329A",
      lead: "A wave of metal wrapped around the waist.",
      desc: "Wide belt in black leather with a long sculpted buckle in polished steel shaped like a breaking wave. Painted inserts in grey and cream follow the curve of the metal. Worn low on the hips over a skirt or a coat.",
      image: "img/belt-wave/main.webp", images: [] },
    { id: "dress-bow", title: "Draped Bow Dress", category: "clothes",
      price: 450, colorGroup: "grey", sku: "NNV0138A",
      lead: "A bow that becomes the whole dress.",
      desc: "Long dress in soft grey satin. A wide bow is knotted over the shoulders and its ends are draped down into a full, gathered skirt. A thin black belt sits at the waist with a small pink pouch attached.",
      image: "img/dress-bow/main.webp", images: [] },
    { id: "set-cape-quilt", title: "Quilted Cape & Skirt Set", category: "clothes",
      price: 520, colorGroup: "grey", sku: "NNV0139A",
      lead: "A cape and a skirt cut from one checked cloth.",
      desc: "Two-piece set in grey checked wool: a short round cape with a painted landscape on the shoulders, and a long skirt gathered into deep sculpted folds at the hips. Each piece is worn on its own or together.",
      image: "img/set-cape-quilt/main.webp", images: [] }
  ]
};
