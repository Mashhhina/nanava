...
window.NNV_DATA = {
  ...
  items: [
    ...
    { id: "sweater-rider", title: "Rider Sweater Red", category: "clothes",
      ...
      process: [{ src: "img/process/board-rider-red.webp", cap: "Red rider sweater: standard shoulder line, sleeve and front placement; monogram bag and cardholder on the same sheet" }] },
    ...
    { id: "mockneck-dark-rider", title: "Dark Rider Satin Mockneck", category: "clothes",
      ...
      process: [{ src: "img/process/board-knight-black.webp", cap: "Black three-thread cotton with knight graphic: ribbed collar and cuffs, embroidery vs print; lace-hem skirt and the faces tote" }] },
    ...
    { id: "tee-riders", title: "Riders Oversized T-Shirt", category: "clothes",
      ...
      process: [{ src: "img/process/board-tee-offwhite.webp", cap: "Off-white oversize tee: silk-screen knight print, 100% cotton, care marks" }, { src: "img/process/board-towel-knight.webp", cap: "Rider silhouette on the towel, the ink-drawn knight on a tee and the pink cardholder" }] },
    ...
    { id: "bag-nanava", title: "NANAVA Raffia Bag", category: "bags",
      ...
      process: [{ src: "img/process/board-rider-red.webp", cap: "Red rider sweater: standard shoulder line, sleeve and front placement; monogram bag and cardholder on the same sheet" }, { src: "img/process/board-knight-black.webp", cap: "Black three-thread cotton with knight graphic: ribbed collar and cuffs, embroidery vs print; lace-hem skirt and the faces tote" }] },
    ...
    { id: "cardholder-nanava", title: "NANAVA Cardholder", category: "accessories",
      ...
      process: [{ src: "img/process/board-rider-red.webp", cap: "Red rider sweater: standard shoulder line, sleeve and front placement; monogram bag and cardholder on the same sheet" }, { src: "img/process/board-towel-knight.webp", cap: "Rider silhouette on the towel, the ink-drawn knight on a tee and the pink cardholder" }] },
    ...
    { id: "sweater-shadow", title: "Shadow Turtleneck Grey", category: "clothes",
      ...
      process: [{ src: "img/sweater-shadow/process.webp", cap: "Working sheets for the shadow turtleneck: the hand-shadow print, melange grey, long sleeves and the crew neck, 100% cotton, care marks" }] },
